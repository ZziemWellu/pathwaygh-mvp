...
function App() {
  ...
  const tabs = [
    ...
    { id: 'admission', label: '📊 Admission Predictor', component: AdmissionPredictor },
  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', maxWidth: '1200px', margin: '0 auto', padding: '20px' }}>
      <header style={{ textAlign: 'center', marginBottom: '30px' }}>
        ...
        <p style={{ fontSize: '14px', color: '#888' }}>Powered by official Ghanaian university admission data</p>
      </header>

      <div style={{ display: 'flex', justifyContent: 'center', gap: '10px', marginBottom: '30px', borderBottom: '2px solid #e0e0e0', paddingBottom: '10px', flexWrap: 'wrap' }}>
        {tabs.map(tab => (
          <button
            key={tab.id}
      ...
      <footer style={{ textAlign: 'center', marginTop: '50px', padding: '20px', color: '#888', borderTop: '1px solid #eee' }}>
        ...
        <p style={{ fontSize: '12px' }}>📚 Real Ghanaian Data | UG | KNUST | UHAS | UCC | Ashesi</p>
      </footer>
    </div>
  )
}
